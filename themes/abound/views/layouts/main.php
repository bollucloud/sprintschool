  ...
  <head>
	...
	<?php  
	  ...
	  $cs->registerCssFile($baseUrl.'/css/abound.css');
          $cs->registerCssFile($baseUrl.'/css/style-'.AppParams::model()->findByAttributes(array('param'=>'style'))->value.'.css');
...
<section class="main-body">
    <div class="container main-container <?php if(Yii::app()->user->name==="Manideep") echo 'admin-main-container'; ?>">
