...
class Vehicles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('route_id, occupancy, create_user_id, update_user_id', 'numerical', 'integerOnly'=>true),
			array('registration_number, status', 'length', 'max'=>255),
			array('create_time, update_time', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, registration_number, route_id, occupancy, status, create_time, create_user_id, update_time, update_user_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('occupancy',$this->occupancy);
