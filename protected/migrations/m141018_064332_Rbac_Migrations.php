...
class m141018_064332_Rbac_Migrations extends CDbMigration
{
	public function up()
	{
...
//            ), 'ENGINE=InnoDB');
            ...
            $this->addForeignKey('fk_parent_name', 'tbl_auth_item_child', 'parent', 'tbl_auth_item', 'name', 'CASCADE', 'CASCADE');
