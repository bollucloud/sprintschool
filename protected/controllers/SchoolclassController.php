...
//        public $layout='layoutbootstrap';
	...
	{
                $assignmentDataProvider = new CActiveDataProvider('Assignment', array(
                        'criteria'=>array(
                            'condition'=>'class_id=:classID',
                            'params'=>array(':classID' => $this->loadModel($id)->id,
                            )
                        ),
                        'pagination'=>array(
                            'pageSize'=>5,
			...
			'model'=>$this->loadModel($id),
                        'assignment'=>$assignmentDataProvider,
		));
	}
	 ...
	 * @param Schoolclass $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='schoolclass-form')
		{
